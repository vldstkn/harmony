...
const (
	Email_ConfirmEmail_FullMethodName = "/Email/ConfirmEmail"
)
...
type EmailClient interface {
	ConfirmEmail(ctx context.Context, in *ConfirmEmailSendReq, opts ...grpc.CallOption) (*ConfirmEmailSendRes, error)
}
...
func (c *emailClient) ConfirmEmail(ctx context.Context, in *ConfirmEmailSendReq, opts ...grpc.CallOption) (*ConfirmEmailSendRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ConfirmEmailSendRes)
	err := c.cc.Invoke(ctx, Email_ConfirmEmail_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EmailServer interface {
	ConfirmEmail(context.Context, *ConfirmEmailSendReq) (*ConfirmEmailSendRes, error)
...
func (UnimplementedEmailServer) ConfirmEmail(context.Context, *ConfirmEmailSendReq) (*ConfirmEmailSendRes, error) {
...
func _Email_ConfirmEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ConfirmEmailSendReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EmailServer).ConfirmEmail(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Email_ConfirmEmail_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmailServer).ConfirmEmail(ctx, req.(*ConfirmEmailSendReq))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Email_ConfirmEmail_Handler,
		},
	},
